...
SET_TO_TASK_TO_DS_TO_PROMPT = {
    ...
    'e5': {
        "Classification": {
            'TNews': 'Represent this text:',
            'IFlyTek': 'Represent this text:',
            'MultilingualSentiment': 'Represent this text:',
            'JDReview': 'Represent this text:',
            'OnlineShopping': 'Represent this text:',
            'Waimai': 'Represent this text:',
            'AmazonReviewsClassificationZh': 'Represent this text:',
            'MassiveIntentClassificationZh': 'Represent this text:',
            'MassiveScenarioClassificationZh': 'Represent this text:',
            
            # 'TNews': '将给定的今日头条新闻进行分类',
            # 'IFlyTek': '将给定的关于APP应用程序的描述的进行分类',
            # 'MultilingualSentiment': '将电商评论进行情感分类，分类为正面、中性或负面情感',
            # 'JDReview': '对来自京东商城的评论进行情感分类为正面或负面情感',
            # 'OnlineShopping': '对来自电商购物的评论进行情感分类为正面或负面情感',
            # 'Waimai': '对来自外卖用户的评论进行情感分类为正面或负面情感',
            # 'AmazonReviewsClassificationZh': 'Classify the given Amazon review into its appropriate rating category',
            # 'MassiveIntentClassificationZh': '将用户的输入作为查询，找出用户意图',
            # 'MassiveScenarioClassificationZh': 'Represent this text:',
        ...
        "Clustering": {
            ...
            # "CLSClusteringS2S": "根据标题识别隶属的学科类别",
            # "CLSClusteringP2P": "根据标题和摘要识别隶属的学科类别",
            # "ThuNewsClusteringS2S": "根据标题识别新闻的具体类别",
            # "ThuNewsClusteringP2P": "根据标题识别新闻的具体类别",
            
            'CLSClusteringS2S': 'Represent this text:',
            'CLSClusteringP2P': 'Represent this text:',
            'ThuNewsClusteringS2S': 'Represent this text:',
            'ThuNewsClusteringP2P': 'Represent this text:',
        ...
        "PairClassification": {
            # 'Ocnli': '检索与给定文本语义相似的文本',
            # 'Cmnli': '检索与给定文本语义相似的文本',
            'Ocnli': 'Represent this text:',
            'Cmnli': 'Represent this text:',
            'SprintDuplicateQuestions': 'Retrieve duplicate questions from Sprint forum',
            'TwitterSemEval2015': 'Retrieve tweets that are semantically similar to the given tweet',
            'TwitterURLCorpus': 'Retrieve tweets that are semantically similar to the given tweet',
        },
        "Reranking": {
            # "T2Reranking": {"query": "检索与下面问题最相关的文本", "corpus": ""},
            # "MmarcoReranking": {"query": "检索与下面问题最相关的文本", "corpus": ""},
            # "CMedQAv1": {"query": "检索与下面问题最相关的文本", "corpus": ""},
            # "CMedQAv2": {"query": "检索与下面问题最相关的文本", "corpus": ""},

            "T2Reranking":{
                "query":"Represent this text:",
                "corpus":""
            },
            "MmarcoReranking":{
                "query":"Represent this text:",
        ...
        'Retrieval': {
            # "T2Retrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "MMarcoRetrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "DuRetrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "CovidRetrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "CmedqaRetrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "EcomRetrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "MedicalRetrieval": {"query": "R给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            # "VideoRetrieval": {"query": "给定一段描述或问题，检索与其最相关的文本", "corpus": ""},
            "T2Retrieval":{
                "query":"Represent this text:",
                "corpus":""
            },
        ...
        'STS': {
            ...
            'ATEC': "Represent this text:",
            'BQ': "Represent this text:",
            'LCQMC': "Represent this text:",
            'PAWSX': "Represent this text:",
            'STSB': "Represent this text:",
            'AFQMC': "Represent this text:",
            'QBQTC': "Represent this text:",
            'STS22_zh': "Represent this text:",
    ...
    'e5zh': {
        "Classification": {
            "TNews": "分类新闻文本",
            "IFlyTek": "分类关于应用程序的描述",
            "MultilingualSentiment": "分类电商评论的情感倾向（正面、中性或负面）",
            "JDReview": "分类电商评论的情感倾向（正面、中性或负面）",
            "OnlineShopping": "分类电商评论的情感倾向（正面或负面）",
            "Waimai": "分类外卖用户评论的情感倾向（正面、中性或负面）",
            "AmazonReviewsClassificationZh": "分类电商评论的情感倾向（正面或负面）",
            "MassiveIntentClassificationZh": "分类该文本至具体的意图类别",
            "MassiveScenarioClassificationZh": "分类该文本至具体的场景类别",
...
if __name__ == '__main__':
    ...
    if args.pipeline_parallel:
        ...
        kwargs["max_memory"] = get_gpus_max_memory("15GB")
    ...
    for (task_name, task_type) in tasks:
        ...
        if not args.no_instruction:
            ...
            if task_name.startswith("CQADupstack") and \
                ...
                # Important!!, if name not in specific type.
        ...
        eval_splits = ['dev' if task_name in ['MSMARCO', 'T2Reranking', 'MmarcoReranking', 'T2Retrieval',
                        'DuRetrieval', 'CovidRetrieval', 'CmedqaRetrieval', 'EcomRetrieval', 'MedicalRetrieval', 
                        'VideoRetrieval', 'T2RetrievalSub', 'MMarcoRetrieval'] else 'test']
        
        eval_splits = ['validation' if task_name in ['TNews', 'IFlyTek', 'MultilingualSentiment', 'Ocnli',
                        'Cmnli', 'AFQMC'] else eval_splits[0] ]
        
        evaluation = MTEB(tasks=[task_name], task_langs=['zh'])
        evaluation.run(
            model,
